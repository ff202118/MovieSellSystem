            ...
            <div id="page-wrapper" class="gray-bg dashbard-1" style="margin-left: 0;">
                <div class="row border-bottom" style=" margin-bottom: 0;">
                    <nav class="navbar navbar-default" style=" margin-bottom: 0;background-color: #906bff;">
                        <div class="navbar-header" style=" margin-bottom: 0;">
                            <a href="indexadmin.jsp#menu_1" onclick="loadPage('searchadmin.jsp')">
                        ...
                        <div id="navMenu">
                            <ul class="nav navbar-toolbar nav-tabs navbar-left hidden-xs">
                                ...
                                <li role="presentation" id="tab_1">
                                    <a data-toggle="tab" href="#menu_1" onclick="loadPage('searchadmin.jsp')">
                                        <i style="color:gray;"></i> <span style="font-size: 18px;">电影查询</span>
                                    </a>
                                </li>

                                <li role="presentation" id="tab_2">
                                    <a data-toggle="tab" href="#menu_2" onclick="loadPage('GetAllMovies')">
                                        <i  style="color:gray;"></i> <span style="font-size: 18px;">电影售票</span>
                                    </a>
                                </li>
                                
                                <li role="presentation" id="tab_3">
                                    <a data-toggle="tab" href="#menu_3" onclick="loadPage('GetAllUsers')">
                                        <i  style="color:gray;"></i> <span style="font-size: 18px;">用户管理</span>
                                    </a>
                                </li>
                ...
                <div class="row mainContent" id="content-main" th:classappend="${mainClass}">
                    <iframe class="RuoYi_iframe" name="iframe0" width="100%" height="100%" id="page-frame"
                            src="searchadmin.jsp" frameborder="0" seamless></iframe>
                </div>
